...
CactusCourt = 14200
HighNoonNook = 14300
ConstructionZone = 21000
PavementPath = 21100
BedrockBoulevard = 21200
SawmillStreet = 21300
HoodHierarchy = {ToontownCentral: (SillyStreet, LoopyLane, PunchlinePlace),
 ...
 TheBrrrgh: (WalrusWay, SleetStreet, PolarPlace, BlizzardBypass),
 MinniesMelodyland: (AltoAvenue, BaritoneBoulevard, TenorTerrace),
 DaisyGardens: (ElmStreet, MapleStreet, OakStreet),
 OutdoorZone: (WalnutWay,),
 DonaldsDreamland: (LullabyLane, PajamaPlace, SlumberStreet),
 WackyWest: (RodeoRoad, CactusCourt, HighNoonNook),
 ConstructionZone: (PavementPath, BedrockBoulevard, SawmillStreet),
 GoofySpeedway: ()}
MyEstate = 16000
GolfZone = 17000
PartyHood = 18000
DynamicZonesBegin = 26000
DynamicZonesEnd = 1 << 25
cogDept2index = {'c': 0,
 'l': 1,
 'm': 2,
 's': 3}
...
Hoods = (DonaldsDock,
 ...
 ConstructionZone,
 GolfZone)
HoodsDiscoveredMax = [DonaldsDock,
 ToontownCentral,
 TheBrrrgh,
 MinniesMelodyland,
 DaisyGardens,
...
MinigamePlayerMatrix = {
    1: (CannonGameId, MazeGameId, TugOfWarGameId, PatternGameId, RingGameId, VineGameId, CogThiefGameId, TwoDGameId, DivingGameId, CatchGameId, TargetGameId),
...
BossCogDamageLevels = {BossCogElectricFence: 1, # TODO: split these into all 4 depts.
 BossCogSwatLeft: 5,
 BossCogSwatRight: 5,
...
SellbotBossDamageLevels = {
 BossCogSwatLeft: 7,
 BossCogSwatRight: 7,
 BossCogStrafeAttack: 3,
 BossCogElectricFence: 2,
 BossCogRecoverDizzyAttack: 8,
 BossCogAreaAttack: 12,
 BossCogDirectedAttack: 8,
 BossCogFrontAttack: 4}
...
ExecutiveInvasionBegin = 13
ExecutiveInvasionEnd = 14
ExecutiveInvasionBulletin = 15
VirtualInvasionBegin = 16
VirtualInvasionEnd = 17
VirtualInvasionBulletin = 18
...
SuitInvasions = {
 ...
 ExecutiveInvasionBegin: TTLocalizer.ExecutiveInvasionBegin,
 ExecutiveInvasionEnd: TTLocalizer.ExecutiveInvasionEnd,
 ExecutiveInvasionBulletin: TTLocalizer.ExecutiveInvasionBulletin,
 VirtualInvasionBegin: TTLocalizer.VirtualInvasionBegin,
 VirtualInvasionEnd: TTLocalizer.VirtualInvasionEnd,
 VirtualInvasionBulletin: TTLocalizer.VirtualInvasionBulletin
}
SUMMER_FIREWORKS = 1
...
GloveCost = 2000
CheesyCost = 800
NametagColorCost = 500
NametagStyleCost = 500
...
TOONUP_PULSE_ZONES = [ToontownCentral, DonaldsDock, DaisyGardens, MinniesMelodyland, TheBrrrgh, DonaldsDreamland, WackyWest, ConstructionZone]
TOONUP_FREQUENCY = 30
...
INVASION_ONLY_DISTRICTS = [402000001]
INVASION_SAFE_DISTRICTS = []
...
VIRTUAL_LUCK_DMG_RANGE = (0, 7)
RANDOM_VIRTUAL_CHOICES = [1, 2, 3, 4, 5]
VIRTUAL_BOSS_CHANCE = 0.15


HARD_DAMAGE_BONUS = 0.5
EXTREME_DAMAGE_BONUS = 1
EXECUTIVE_DAMAGE_BONUS = 0.5
EXECUTIVE_DEF_BONUS = 5
VIRTUAL_HP_MULT = 2
VIRTUAL_DEF_BONUS = 10
VIRTUAL_DEF_CHANCE = 0.2
VIRTUAL_ACC_CHANCE = 0.3
CRIT_DAMAGE_BONUS = 0.4

MAX_SUIT_DEFENSE = 0.6
...
FACTORY_JELLYBEAN_REWARD_EXTREME = 1000
FACTORY_JELLYBEAN_REWARD_HARD = 500

TROLLEY_POSITION_SIT = 0
TROLLEY_POSITION_STAND = 1
