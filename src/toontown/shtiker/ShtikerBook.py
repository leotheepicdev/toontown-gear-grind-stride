...
class ShtikerBook(DirectFrame, StateData.StateData):
    ...
    def enter(self):
        ...
        base.disableMouse()
        base.render.setColorScale(0.45, 0.45, 0.45, 1)
        ...
        if not self.safeMode:
            ...
            self.enableShtikerBookKeybinds()
    ...
    def exit(self):
        ...
        self.disableShtikerBookKeybinds()
    ...
    def addPageTab(self, page, pageIndex, pageName = 'Page'):
        ...
        elif pageName == TTLocalizer.ItemPageTitle:
            iconGeom = iconModels = OnscreenImage(image='phase_3.5/maps/itempage_icon.png')
