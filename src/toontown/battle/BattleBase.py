...
from toontown.base.ToontownGlobals import BattleTimeout
TOON_ID_COL = 0
TOON_TRACK_COL = 1
TOON_LVL_COL = 2
TOON_TGT_COL = 3
...
CLIENT_INPUT_TIMEOUT = config.GetFloat('battle-input-timeout', BattleTimeout)
