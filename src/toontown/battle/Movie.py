        ...
        for ta in toonAttacks:
            ...
            if track != NO_ATTACK:
                ...
                if track == SOS:
                    ...
                    adict['target'] = target
                elif track in (NPCSOS, NPC_COGS_MISS, NPC_TOONS_HIT, NPC_ORGANIC_GAGS, NPC_DOODLES_POWER, NPC_BONUS_POWER, NPC_RESTOCK_GAGS, PETSOS):
                    adict['special'] = 1
                    toonHandles = []
                    for t in toons:
                        if t != -1:
                            ...
                            if target == None:
                                continue
                            if track in (NPC_TOONS_HIT, NPC_ORGANIC_GAGS, NPC_DOODLES_POWER, NPC_BONUS_POWER) and t == toonId:
                                continue
