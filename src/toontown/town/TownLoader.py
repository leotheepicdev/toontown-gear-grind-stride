from panda3d.core import CollideMask, Light, ModelPool, NodePath, Texture, TexturePool, Vec4
...
class TownLoader(StateData.StateData):
    ...
    zone2music = {
        ToontownCentral : 'phase_3.5/audio/bgm/encntr_ttc_bg.ogg',
    }
    ...
    def load(self, zoneId):
        ...
        self.battleMusic = loader.loadMusic(self.zone2music.get(ZoneUtil.getHoodId(zoneId), 'phase_3.5/audio/bgm/encntr_general_bg.ogg'))
