...
class DistributedNPCToon(DistributedNPCToonBase):
    ...
    def neutralizeCamera(self):
        ...
        Sequence(Func(camera.wrtReparentTo, base.localAvatar), camera.posQuatInterval(1, (0, -9 * scaleFactor, avHeight), (0, 0, 0), 
                      other=base.localAvatar, blendType='easeOut'), Func(base.cr.playGame.getPlace().setState, 'walk')).start()
