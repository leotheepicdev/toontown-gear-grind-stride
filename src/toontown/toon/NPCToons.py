from panda3d.core import ConfigVariable, ConfigVariableList, Point3
from lib.nametag.NametagGroup import *
...
def createNPC(air, npcId, desc, zoneId, posIndex = 0, questCallback = None):
    ...
    import DistributedNPCCheesyEffectAI
    import DistributedNPCNametagAI
    canonicalZoneId, name, dnaType, gender, protected, type = desc
    if type == NPC_REGULAR:
        npc = DistributedNPCToonAI.DistributedNPCToonAI(air, npcId, questCallback=questCallback)
    elif type == NPC_HQ:
        npc = DistributedNPCHQAI.DistributedNPCHQAI(air, npcId, questCallback=questCallback, hq=1)
    elif type == NPC_CLERK:
    ...
    elif type == NPC_CHEESY:
        npc = DistributedNPCCheesyEffectAI.DistributedNPCCheesyEffectAI(air, npcId)
    elif type == NPC_NAMETAG:
        npc = DistributedNPCNametagAI.DistributedNPCNametagAI(air, npcId)
    else:
...
NPCToonDict = {
 ...
 2007: (2520, lnames[2007], ('dls', 'ms', 'm', 'm', 6, 0, 6, 6, 0, 10, 0, 10, 2, 9), 'm', 1, NPC_HQ),
 2008: (2520, lnames[2008], ('rls', 'ls', 'l', 'm', 13, 0, 13, 13, 111, 27, 98, 27, 41, 27), 'm', 1, NPC_HQ),
 2009: (2520, lnames[2009], ('css', 'ss', 'm', 'f', 26, 0, 26, 26, 95, 0, 84, 0, 40, 0), 'f', 1, NPC_HQ),
 2010: (2520, lnames[2010], ('dll', 'ms', 'm', 'm', 7, 0, 7, 7, 2, 6, 2, 6, 2, 16), 'm', 1, NPC_HQ),
 ...
 2022: (2000, lnames[2022], ('mls', 'ms', 's', 'm', 10, 0, 10, 10, 1, 16, 1, 16, 0, 2), 'm', 1, NPC_CHEESY),
 2023: (2000, lnames[2023], ('cls', 'ss', 'm', 'f', 24, 0, 24, 24, 0, 0, 0, 0, 0, 3), 'f', 1, NPC_NAMETAG),
 2024: (-1, lnames[2024], ('dls', 'ld', 'l', 'f', 22, 0, 22, 22, 0, 6, 0, 6, 3, 7), 'f', 0, NPC_REGULAR),
 2025: (-1, lnames[2025], ('fsl', 'ms', 'l', 'm', 19, 0, 19, 19, 0, 10, 0, 10, 1, 10), 'm', 0, NPC_REGULAR),
 2026: (-1, lnames[2026], ('cls', 'l', 'm', 'm', 26, 0, 26, 26, 1, 9, 1, 9, 0, 11), 'm', 0, NPC_REGULAR),
 2027: (-1, lnames[2027], ('hss', 'ms', 's', 'f', 12, 0, 12, 12, 1, 21, 1, 21, 1, 24), 'f', 0, NPC_REGULAR),
 ...
 2407: (2907, lnames[2407], ('mss', 'ss', 'l', 'm', 12, 0, 12, 12, 0, 8, 0, 8, 0, 16), 'm', 1, NPC_REGULAR),
 ...
 2413: (2910, lnames[2413], ('cls', 'ls', 's', 'm', 12, 0, 12, 12, 1, 23, 1, 23, 11, 27), 'm', 1, NPC_REGULAR),
 2414: (2912, lnames[2414], 'r', 'm', 0, NPC_REGULAR),
 2415: (2913, lnames[2415], ('dss', 'ls', 'm', 'm', 18, 0, 18, 18, 0, 11, 0, 11, 0, 9), 'm', 0, NPC_REGULAR),
 2416: (2411, lnames[2416], ('dsl', 'm', 'l', 'm', 28, 0, 28, 28, 1, 3, 1, 3, 0, 6), 'm', 0, NPC_FISHERMAN),
 ...
 9301: (9801, lnames[9301], ('css', 'ld', 'l', 'f', 17, 0, 17, 17, 5, 21, 5, 21, 8, 26), 'f', 0, NPC_REGULAR),
 9302: (9802, lnames[9302], 'r', 'm', 0, NPC_REGULAR),
 9303: (9803, lnames[9303], ('dss', 'ls', 's', 'm', 16, 0, 16, 16, 14, 10, 10, 10, 3, 19), 'm', 0, NPC_REGULAR),
 9304: (9804, lnames[9304], 'r', 'm', 0, NPC_REGULAR),
 9305: (9805, lnames[9305], 'r', 'm', 0, NPC_REGULAR),
 9306: (9806, lnames[9306], 'r', 'f', 0, NPC_REGULAR),
 9307: (9807, lnames[9307], 'r', 'f', 0, NPC_REGULAR),
 9308: (9808, lnames[9308], ('css', 'ms', 'm', 'm', 26, 0, 26, 26, 8, 4, 8, 4, 7, 4), 'm', 0, NPC_REGULAR),
 9309: (9809, lnames[9309], 'r', 'm', 0, NPC_REGULAR),
 9310: (9810, lnames[9310], ('dls', 'ls', 'm', 'm', 24, 0, 18, 18, 11, 7, 0, 7, 1, 11), 'm', 0, NPC_REGULAR),
 9312: (9812, lnames[9312], 'r', 'f', 0, NPC_REGULAR),
 9313: (9813, lnames[9313], 'r', 'm', 0, NPC_REGULAR),
 9314: (9814, lnames[9314], 'r', 'm', 0, NPC_REGULAR),
 9315: (9815, lnames[9315], 'r', 'f', 0, NPC_REGULAR),
 9316: (9816, lnames[9316], 'r', 'f', 0, NPC_REGULAR),
 9317: (9817, lnames[9317], ('css', 'md', 's', 'f', 22, 0, 22, 22, 7, 4, 7, 4, 8, 11), 'f', 0, NPC_REGULAR),
 9318: (9818, lnames[9318], 'r', 'm', 0, NPC_HQ),
 9319: (9818, lnames[9319], ('css', 'ls', 'm', 'm', 26, 0, 26, 26, 5, 11, 5, 11, 5, 11), 'm', 0, NPC_HQ),
 9320: (9818, lnames[9320], 'r', 'm', 0, NPC_HQ),
 9321: (9818, lnames[9321], ('dss', 'ms', 'm', 'm', 2, 0, 2, 2, 4, 1, 4, 1, 2, 16), 'm', 0, NPC_HQ),
 9322: (9819, lnames[9322], ('dss', 'ms', 'm', 'm', 15, 0, 15, 15, 5, 6, 5, 6, 7, 9), 'f', 0, NPC_REGULAR),
 9323: (9820, lnames[9323], ('css', 'ms', 's', 'm', 31, 0, 31, 31, 8, 2, 8, 2, 5, 11), 'm', 0, NPC_REGULAR),
 9324: (9311, lnames[9324], 'r', 'm', 0, NPC_FISHERMAN),

 14030: (14021, lnames[14030], ('rss', 'md', 'l', 'f', 19, 0, 19, 19, 1, 8, 1, 8, 7, 7), 'f', 0, NPC_TAILOR),

 21002: (21000, lnames[21002], ('rss', 'ls', 'l', 'm', 17, 0, 17, 17, 1, 6, 1, 6, 1, 1), 'm', 1, NPC_FISHERMAN),
 21003: (21508, lnames[21003], ('csl', 'ls', 'm', 'm', 9, 0, 9, 9, 1, 12, 1, 12, 0, 20), 'm', 0, NPC_TAILOR),
 21004: (21000, lnames[21004], ('rll', 'ms', 'l', 'f', 16, 0, 16, 16, 1, 7, 1, 7, 3, 8), 'f', 1, NPC_HQ),
 21005: (21000, lnames[21005], ('rss', 'ld', 'l', 'f', 9, 0, 9, 9, 1, 8, 1, 8, 19, 27), 'f', 1, NPC_HQ),
 21006: (21000, lnames[21006], ('rls', 'ms', 'l', 'm', 22, 0, 22, 22, 1, 6, 1, 6, 0, 1), 'm', 1, NPC_HQ),
 21007: (21000, lnames[21007], ('mls', 'ms', 'l', 'm', 15, 0, 15, 15, 1, 6, 1, 6, 0, 19), 'm', 1, NPC_HQ),
 21008: (21506, lnames[21008], ('hll', 'ss', 'l', 'f', 8, 0, 8, 8, 1, 9, 1, 9, 12, 27), 'f', 0, NPC_CLERK),
 21009: (21506, lnames[21009], ('hss', 'ls', 'l', 'm', 22, 0, 22, 22, 0, 7, 0, 7, 0, 13), 'm', 0, NPC_CLERK),
 21010: (21522, lnames[21010], ('dsl', 'ss', 'm', 'm', 17, 0, 17, 17, 0, 0, 0, 0, 0, 14), 'm', 0, NPC_PETCLERK),
 21011: (21522, lnames[21011], ('dss', 'ld', 'm', 'f', 10, 0, 10, 10, 0, 0, 0, 0, 26, 27), 'f', 0, NPC_PETCLERK),
 21012: (21522, lnames[21012], ('fll', 'sd', 'm', 'f', 1, 0, 1, 1, 0, 1, 0, 1, 4, 25), 'f', 0, NPC_PETCLERK),
 21015: (21518, lnames[21015], ('dls', 'ms', 'm', 'm', 6, 0, 6, 6, 97, 27, 86, 27, 37, 27), 'm', 0, NPC_REGULAR),
 21101: (21601, lnames[21101], ('rll', 'ms', 'l', 'm', 15, 0, 15, 15, 0, 9, 0, 9, 0, 6), 'm', 1, NPC_REGULAR),
 21102: (21619, lnames[21102], 'r', 'f', 0, NPC_REGULAR),
 21103: (21616, lnames[21103], ('cls', 'm', 's', 'm', 9, 0, 9, 9, 0, 11, 0, 11, 49, 10), 'm', 0, NPC_REGULAR),
 21104: (21671, lnames[21104], ('mls', 'ms', 'm', 'm', 15, 0, 15, 15, 1, 10, 1, 10, 0, 16), 'm', 1, NPC_HQ),
 21105: (21671, lnames[21105], ('hsl', 'ss', 'm', 'm', 7, 0, 7, 7, 1, 10, 1, 10, 0, 13), 'm', 1, NPC_HQ),
 21106: (21671, lnames[21106], ('hss', 'ld', 'm', 'f', 23, 0, 23, 23, 1, 23, 1, 23, 24, 27), 'f', 1, NPC_HQ),
 21107: (21671, lnames[21107], ('cll', 'sd', 'm', 'f', 14, 0, 14, 14, 1, 24, 1, 24, 7, 4), 'f', 1, NPC_HQ),
 21108: (21603, lnames[21108], ('csl', 'ms', 'm', 'f', 7, 0, 7, 7, 1, 24, 1, 24, 3, 2), 'f', 1, NPC_REGULAR),
 21109: (21604, lnames[21109], 'r', 'm', 1, NPC_REGULAR),
 21110: (21605, lnames[21110], ('dll', 'ls', 'm', 'm', 14, 0, 14, 14, 0, 27, 0, 27, 0, 15), 'm', 0, NPC_REGULAR),
 21111: (21607, lnames[21111], 'r', 'm', 1, NPC_REGULAR),
 21112: (21610, lnames[21112], ('fll', 'ss', 'm', 'm', 20, 0, 20, 20, 0, 27, 0, 27, 0, 9), 'm', 1, NPC_REGULAR),
 21113: (21617, lnames[21113], ('fsl', 'ls', 'm', 'm', 14, 0, 14, 14, 0, 0, 0, 0, 0, 2), 'm', 0, NPC_REGULAR),
 21114: (21618, lnames[21114], ('fls', 'sd', 'm', 'f', 6, 0, 6, 6, 0, 0, 0, 0, 23, 27), 'f', 0, NPC_REGULAR),
 21115: (21621, lnames[21115], ('rll', 'ms', 'l', 'f', 22, 0, 22, 22, 1, 1, 1, 1, 26, 27), 'f', 0, NPC_REGULAR),
 21116: (21624, lnames[21116], ('rss', 'ls', 'l', 'm', 13, 0, 13, 13, 1, 1, 1, 1, 1, 14), 'm', 0, NPC_REGULAR),
 21117: (21625, lnames[21117], ('rls', 'sd', 'l', 'f', 6, 0, 6, 6, 1, 2, 1, 2, 25, 27), 'f', 0, NPC_REGULAR),
 21118: (21626, lnames[21118], ('mls', 'ss', 'l', 'm', 20, 0, 20, 20, 1, 1, 1, 1, 1, 6), 'm', 0, NPC_REGULAR),
 21119: (21629, lnames[21119], ('hll', 'ss', 'l', 'f', 13, 0, 13, 13, 1, 3, 1, 3, 19, 27), 'f', 1, NPC_REGULAR),
 21120: (21632, lnames[21120], ('hss', 'ls', 'l', 'm', 5, 0, 5, 5, 1, 2, 1, 2, 1, 19), 'm', 0, NPC_REGULAR),
 21121: (21633, lnames[21121], ('cll', 'ls', 'l', 'f', 21, 0, 21, 21, 0, 4, 0, 4, 4, 4), 'f', 0, NPC_REGULAR),
 21122: (21639, lnames[21122], ('csl', 'ss', 'l', 'm', 26, 0, 26, 26, 0, 3, 0, 3, 1, 13), 'm', 0, NPC_REGULAR),
 21141: (21000, lnames[21141], ('dss', 'ms', 'l', 'm', 15, 0, 15, 15, 1, 10, 1, 10, 0, 16), 'm', 1, NPC_CHEESY),
 21142: (21000, lnames[21142], ('fll', 'ld', 'l', 'f', 7, 0, 7, 7, 1, 10, 1, 10, 7, 6), 'f', 1, NPC_GLOVE),
 ...
 16001: (-1, lnames[16001], ('dss', 'ms', 'm', 'm', 19, 0, 19, 19, 2, 8, 2, 8, 0, 15), 'm', 0, NPC_FISHERMAN),
 90001: (-1, lnames[90001], ('css', 'md', 'm', 'f', 24, 32, 24, 24, 13, 24, 11, 24, 7, 9), 'f', 0, NPC_REGULAR)
}
...
GlovePositions = {lnames[2021]: ((101, -14, 4), -305), 
                  lnames[21142]: ((296.681, 59.749, 0.1), -260)}
CheesyPositions = {lnames[2022]: ((101, 15.5, 4), -245), 
                   lnames[21141]: ((294.368, 70.628, 0.1), -270)}
HqPositions = {lnames[21004]: ((-136.62, 53.868, 2.55), 180),
               lnames[21005]: ((-130.368, 57.628, 2.55), 180),
               lnames[21006]: ((-150.127, 84.644, 2.55), 0),
               lnames[21007]: ((-145.197, 86.992, 2.55), 0)}               
NametagColorPositions = {lnames[2023]: ((107, -48, 4), -320)}
del lnames
zone2NpcDict = {}
...
LegacynpcFriends = {
 90001: (ToontownBattleGlobals.NPC_ORGANIC_GAGS, 0, 2, 6)
}
...
HQnpcFriends = {
 ...
 3007: (ToontownBattleGlobals.TRAP_TRACK, 4, 90, 4),
 ...
 2024: (ToontownBattleGlobals.THROW_TRACK, 6, 132, 5),
 2025: (ToontownBattleGlobals.THROW_TRACK, 6, 110, 4),
 2026: (ToontownBattleGlobals.SQUIRT_TRACK, 6, 120, 5),
 2027: (ToontownBattleGlobals.SQUIRT_TRACK, 6, 90, 4),
 ...
 2013: (ToontownBattleGlobals.NPC_DOODLES_POWER, 0, 2, 5),
 2007: (ToontownBattleGlobals.NPC_BONUS_POWER, 0, 0, 5),
...
FOnpcFriends = {
 ...
 7013: (ToontownBattleGlobals.HEAL_TRACK, 3, 45, 1),
 7014: (ToontownBattleGlobals.HEAL_TRACK, 3, 70, 2),
 7015: (ToontownBattleGlobals.DROP_TRACK, 1, 30, 0),
 ...
 7021: (ToontownBattleGlobals.THROW_TRACK, 6, 30, 0),
 7022: (ToontownBattleGlobals.THROW_TRACK, 6, 40, 1),
 7023: (ToontownBattleGlobals.THROW_TRACK, 6, 50, 2),
 7024: (ToontownBattleGlobals.SQUIRT_TRACK, 6, 30, 0),
 7025: (ToontownBattleGlobals.SQUIRT_TRACK, 6, 40, 1),
 7026: (ToontownBattleGlobals.SQUIRT_TRACK, 6, 50, 2),
}
...
npcFriends.update(LegacynpcFriends)
