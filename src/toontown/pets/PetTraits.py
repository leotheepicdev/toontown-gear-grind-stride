from direct.showbase.PythonUtil import randFloat, normalDistrib, Enum, clampScalar
...
class PetTraits:
    ...
    class StdIncDistrib(TraitDistribution):
        ...
        Sz2MinMax = {ToontownGlobals.ToontownCentral: (0.7, 0.95),
         ToontownGlobals.DonaldsDock: (0.7, 0.95),
         ToontownGlobals.DaisyGardens: (0.7, 0.95),
         ToontownGlobals.MinniesMelodyland: (0.7, 0.95),
         ToontownGlobals.TheBrrrgh: (0.7, 0.95),
         ToontownGlobals.WackyWest: (0.7, 0.95),
         ToontownGlobals.ConstructionZone: (0.7, 0.95),
         ToontownGlobals.DonaldsDreamland: (0.7, 0.95)}

    class StdDecDistrib(TraitDistribution):
        TraitType = TraitDistribution.TraitTypes.DECREASING
        Sz2MinMax = {ToontownGlobals.ToontownCentral: (0.1, 0.3),
         ToontownGlobals.DonaldsDock: (0.1, 0.3),
         ToontownGlobals.DaisyGardens: (0.1, 0.3),
         ToontownGlobals.MinniesMelodyland: (0.1, 0.3),
    ...
    class ForgetfulnessDistrib(TraitDistribution):
        TraitType = TraitDistribution.TraitTypes.DECREASING
        Sz2MinMax = {ToontownGlobals.ToontownCentral: (0.0, 0.4),
         ToontownGlobals.DonaldsDock: (0.0, 0.4),
         ToontownGlobals.DaisyGardens: (0.0, 0.4),
         ToontownGlobals.MinniesMelodyland: (0.0, 0.4),
         ToontownGlobals.TheBrrrgh: (0.0, 0.4),
         ToontownGlobals.WackyWest: (0.7, 0.95),
         ToontownGlobals.ConstructionZone: (0.05, 0.25),
         ToontownGlobals.DonaldsDreamland: (0.0, 0.4)}
