...
PetRarities2 = (('leopard', 0.005),
 ...
 ('tummy', 0.525),
 ('threeStripe', 1.0))
PetRarities = {'body': {ToontownGlobals.ToontownCentral: {'threeStripe': 10,
                                            'tummy': 15,
                                            'jellybean': 70,
                                            'dots': 5},
          ToontownGlobals.DonaldsDock: {'threeStripe': 15,
                                        'tummy': 30,
                                        'dots': 50,
                                        'tigerStripe': 5},
          ToontownGlobals.DaisyGardens: {'threeStripe': 5,
                                         'tummy': 5,
                                         'dots': 25,
                                         'tigerStripe': 60,
                                         'turtle': 5},
          ToontownGlobals.MinniesMelodyland: {'threeStripe': 5,
                                              'tummy': 5,
                                              'dots': 5,
                                              'tigerStripe': 25,
                                              'turtle': 60},
          ...
          ToontownGlobals.DonaldsDreamland: {'threeStripe': 5,
                                             ...
                                             'giraffe': 15,
                                             'leopard': 60},
          ToontownGlobals.WackyWest: {'threeStripe': 5,
                                      'tummy': 5,
                                      'dots': 5,
                                      'tigerStripe': 5,
                                      'turtle': 20,
...
BodyTextures = {'dots': 'phase_4/maps/BeanbodyDots6.jpg',
 ...
 'jellybean': 'phase_4/maps/BeanbodyJellybean.jpg',
...
def getFootTexture(bodyType):
    if BodyTypes[bodyType] in ['turtle', 'giraffe', 'leopard']:
        return FeetTextures[BodyTypes[bodyType]]
    return FeetTextures['normal']
