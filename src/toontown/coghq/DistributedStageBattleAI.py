...
from toontown.base.ToontownBattleGlobals import getStageCreditMultiplier
...
class DistributedStageBattleAI(DistributedLevelBattleAI.DistributedLevelBattleAI):
    ...
    def handleToonsWon(self, toons):
        ...
        for toon in toons:
            ...
            meritArray = self.air.promotionMgr.recoverMerits(toon, self.suitsKilled, self.getTaskZoneId(), getStageCreditMultiplier(self.level.getFloorNum()) * 2.5, extraMerits=extraMerits, addInvasion=False)
