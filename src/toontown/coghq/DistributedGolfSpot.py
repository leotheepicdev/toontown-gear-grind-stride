...
from panda3d.core import BitMask32, CollideMask, CollisionHandler, CollisionHandlerEvent, CollisionNode, CollisionSphere, NodePath, Point3, TextNode, VBase4, lookAt
import math
...
class DistributedGolfSpot(DistributedObject.DistributedObject, FSM.FSM):
    ...
    def __enableControlInterface(self):
        ...
        self.accept(base.getKey('FIRE'), self.__controlPressed)
        self.accept(base.getKey('FIRE') + '-up', self.__controlReleased)
    ...
    def __disableControlInterface(self):
        ...
        self.ignore(base.getKey('FIRE') + '-up')
