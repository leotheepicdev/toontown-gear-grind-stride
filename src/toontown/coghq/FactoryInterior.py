...
class FactoryInterior(BattlePlace.BattlePlace):
    ...
    def load(self):
        ...
        self.music = loader.loadMusic('phase_9/audio/bgm/sellbot_hq_factory.ogg')
    ...
    def enterTownBattle(self, event):
        mult = ToontownBattleGlobals.getFactoryCreditMultiplier(self.zoneId, base.cr.distributedDistrict.getDifficulty())
