from panda3d.core import CollideMask, CollisionNode, CollisionTube, GeomNode, NodePath
from direct.actor.Actor import Actor
from direct.directnotify.DirectNotifyGlobal import directNotify
from direct.distributed import ClockDelta
from direct.interval.IntervalGlobal import *
import random
from toontown.magicword import MagicWordManager
from toontown.magicword.MagicWordGlobal import *
from toontown.avatar.ShadowCaster import ShadowCaster
from otp.chat import ChatUtil
from otp.otpbase import OTPGlobals
from otp.otpbase import OTPLocalizer
from toontown.base import ToontownGlobals, ToontownRender
...
class Avatar(Actor, ShadowCaster):
    ...
    def __init__(self, other = None):
        ...
        self.__font = ToontownGlobals.getInterfaceFont()
        self.name = ''
        self.toonTag = ''
        ...
        self.nametag.setSpeechFont(ToontownGlobals.getInterfaceFont())
        ...
        self.getGeomNode().showThrough(ToontownRender.ShadowCameraBitmask)
        self.nametag3d.hide(ToontownRender.ShadowCameraBitmask)
        self.collTube = None
        self.scale = 1.0
        self.height = 0.0
        self.style = None
    ...
    def considerUnderstandable(self):
        if self.playerType == NametagGroup.CCSpeedChat:
    ...
    def setNametagName(self, name=None):
        if not name:
            name = self.name
        if self.toonTag:
            name += '\n\x01orange\x01%s\x02\x02' % self.toonTag
