from panda3d.core import Connection, Notify
...
from toontown.distributed.TelemetryLimited import TelemetryLimited
...
class DistributedPlayer(DistributedAvatar.DistributedAvatar, TelemetryLimited):
    ...
    def setTalk(self, chat):
        ...
        if base.localAvatar.chatLog:
            ...
            base.localAvatar.chatLog.log(avatar.getName(), chat)        
    ...
    def setTalkWhisper(self, avId, chat):
        ...
        if base.localAvatar.chatLog:
            ...
            base.localAvatar.chatLog.log(avatar.getName(), chat, color='caribbeanGreen')      
    ...
    def b_setSC(self, msgIndex, CFType=0):
    ...
    def setSC(self, msgIndex, CFType):
        if base.localAvatar.isIgnored(self.doId):
            return
        chatString = SCDecoders.decodeSCStaticTextMsg(msgIndex)
        if chatString:
