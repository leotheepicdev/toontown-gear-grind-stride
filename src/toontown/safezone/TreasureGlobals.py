...
TreasureOZ = 9
TreasureE  = 10
TreasureJellybeanBag = 11

AvailableBeanBagChoices = [25, 50, 75, 125, 250, 500]
BeanBagValueColors = {25: (1, 0, 0, 1), # TODO: redo these colors
 50: (0, 1, 0, 1),
 75: (0, 0, 1, 1),
 125: (1, 0, 1, 1),
 250: (1, 1, 0, 1), 
...
TreasureModels = {
    ...
    TreasureJellybeanBag: (
        'phase_4/models/props/JellybeanBag',
        'phase_4/audio/sfx/SZ_DD_treasure.ogg',
    ),
}
...
SafeZoneTreasureSpawns = {
    ...
    ToontownGlobals.WackyWest: ( # TODO
        TreasureWW, 21, # WWTreasure heals 21 each...
        [
            (-60.976, -8.866, 1.3),
            (-90.632, -5.828, -0.63),
            (27.1, -93.5, 2.5),
    ...
    ToontownGlobals.ConstructionZone: (
        ...
        [
            (-20.225, 82.128, 2.8),#Bottom left side
            (-30.6, 223.2, 21),
            (-280.8, 222.8, -23.), #Pond
            (-325.0, 146.0, -24.8),   #Pond
            (-0.262, -129.38, 41.2), #Middle Clothing shop
            (137.1, -12.5, 88.6),  #Top of hill
            (33.0, 132.1, 2.6),
            (-69.14, -65.15, 2.62), #Bottom right side
            (-176.9, 144.5, 1.3),
            (-247.95, -3, 0.27),
            (-144.15, -55.757, 2.823),
            (307.93, 15.28, 1.3),
            (-2.3452, 38.9784, 27.5),#Platform
            (144.0, 124.5, 0.351),
            (272.85, 144.917, 0.653),
        ],
        10, # Rate
        10 # Maximum
    ),
