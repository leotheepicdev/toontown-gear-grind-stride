...
class CZPlayground(Playground.Playground):
    ...
    def exit(self):
        ...
        taskMgr.remove('cz-check-toon-underwater')
        taskMgr.remove('cz-check-cam-underwater')
        self.loader.hood.setNoFog

    def enterStart(self):
        self.cameraSubmerged = 0
        self.toonSubmerged = 0
        taskMgr.add(self.__checkToonUnderwater, 'cz-check-toon-underwater')
        taskMgr.add(self.__checkCameraUnderwater, 'cz-check-cam-underwater')
