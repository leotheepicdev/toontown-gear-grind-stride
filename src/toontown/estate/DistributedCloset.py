from panda3d.core import Camera, CollideMask, CollisionNode, CollisionSphere, Vec3
...
class DistributedCloset(DistributedFurnitureItem.DistributedFurnitureItem):
    ...
    def __popupAreYouSurePanel(self):
        ...
        DirectButton(self.popupInfo, clickSound=loader.loadSfx('phase_3/audio/sfx/GUI_create_toon_back.ogg'), image=cancelButtonImage, relief=None, text=TTLocalizer.ClosetPopupCancel, text_scale=0.05, text_pos=(0.0, -0.1), textMayChange=0, pos=(0.1, 0.0, -0.21), command=self._handleNotSure)
        buttons.removeNode()
        self.popupInfo.reparentTo(aspect2d)
        return
