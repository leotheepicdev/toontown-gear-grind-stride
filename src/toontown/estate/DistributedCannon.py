from panda3d.core import BitMask32, CollideMask, CollisionHandler, CollisionHandlerEvent, CollisionHandlerFloor, CollisionNode, CollisionPolygon, CollisionRay, CollisionSphere, Geom, GeomNode, GeomTriangles, GeomVertexData, GeomVertexFormat, GeomVertexWriter, NodePath, Point3, Vec3, Vec4, lookAt
...
from lib.nametag.NametagFloat3d import NametagFloat3d
...
class DistributedCannon(DistributedObject.DistributedObject):
    ...
    HIT_TOWER = 1
    HIT_WATER = 2
    FIRE_KEY = base.getKey('FIRE')
    UP_KEY = base.getKey('MOVE_UP')
    DOWN_KEY = base.getKey('MOVE_DOWN')
    LEFT_KEY = base.getKey('MOVE_LEFT')
    RIGHT_KEY = base.getKey('MOVE_RIGHT')
    BUMPER_KEY = base.getKey('ACTION')
    BUMPER_KEY2 = 'insert'
