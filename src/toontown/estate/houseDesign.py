from panda3d.core import CollideMask, CollisionBox, CollisionEntry, CollisionNode, CollisionPolygon, CollisionSphere, Lens, NodePath, Point3, TextNode, Vec3, Vec4, lookAt
...
class ObjectManager(NodePath, DirectObject):
    ...
    def createVerifyDialog(self, item, verifyText, okFunc, cancelFunc):
        if self.verifyFrame == None:
            ...
            self.okButton = DirectButton(parent=self.verifyFrame, image=okButtonImage, relief=None, text=TTLocalizer.lOK, text_scale=0.05, text_pos=(0.0, -0.1), textMayChange=0, pos=(-0.22, 0.0, -0.5))
            self.cancelButton = DirectButton(parent=self.verifyFrame, image=cancelButtonImage, relief=None, text=TTLocalizer.lCancel, text_scale=0.05, text_pos=(0.0, -0.1), textMayChange=0, pos=(0.22, 0.0, -0.5))
