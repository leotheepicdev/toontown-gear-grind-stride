...
class CogBuildingPlannerAI:
    notify = DirectNotifyGlobal.directNotify.newCategory('CogBuildingPlannerAI')

    def __init__(self, numFloors, difficulty, bldgTrack, zone):
    ...
    def _genSuitInfos(self, numFloors, difficulty, bldgTrack):
        ...
        for currFloor in xrange(numFloors):
            ...
            bldgInfo = SuitBuildingGlobals.CogBuildings[difficulty]
    ...
    def __genSuitObject(self, suitZone, suitType, bldgTrack, suitLevel, revives = 0, virtual = 0):
        ...
        if not newSuit.getSkelecog() and not newSuit.isVirtual():
            if virtual:
