...
colors = {DonaldsDock: {'TI_wainscotting': wainscottingBase,
 ...
 ToontownCentral: {'TI_wainscotting': wainscottingBase,
                   ...
                   'TI_floor': floorBase},
 WackyWest: {'TI_wainscotting': wainscottingBase,
             'TI_wallpaper': wallpaperBase,
             'TI_wallpaper_border': wallpaperBorderBase,
             'TI_door': doorBase + [Vec4(0.8, 0.5, 0.3, 1.0)],
             'TI_floor': floorBase},
 ...
 DonaldsDreamland: {'TI_wainscotting': wainscottingBase,
                    ...
                    'TI_door': doorBase,
                    'TI_floor': floorBase},
 FunnyFarm: {'TI_wainscotting': wainscottingBase,
               'TI_wallpaper': wallpaperBase,
               'TI_wallpaper_border': wallpaperBorderBase + [Vec4(0.6, 0.2, 0.2, 1.0)],
               'TI_door': doorBase + [Vec4(0.6, 0.2, 0.2, 1.0)], 
               'TI_floor': floorBase},
