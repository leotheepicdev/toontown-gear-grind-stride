...
from lib.nametag.NametagFloat2d import *
...
class PartyPlanner(DirectFrame, FSM):
    ...
    def _createPartyEditorPage(self):
        ...
        self.okWithGroundsGui = TTDialog.TTGlobalDialog(dialogName=self.uniqueName('PartyEditorOkGui'), doneEvent=self.okWithPartyGroundsLayoutEvent, message=TTLocalizer.PartyPlannerOkWithGroundsLayout, style=TTDialog.YesNo, okButtonText=TTLocalizer.lYes, cancelButtonText=TTLocalizer.lNo)
        self.okWithGroundsGui.doneStatus = ''
