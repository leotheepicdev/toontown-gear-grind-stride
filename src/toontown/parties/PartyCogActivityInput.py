...
ROTATE_LEFT_KEY = base.getKey('MOVE_LEFT')
ROTATE_RIGHT_KEY = base.getKey('MOVE_RIGHT')
FORWARD_KEY = base.getKey('MOVE_UP')
BACKWARDS_KEY = base.getKey('MOVE_DOWN')
THROW_PIE_KEYS = [base.getKey('FIRE'), base.getKey('ACTION'), 'insert']
