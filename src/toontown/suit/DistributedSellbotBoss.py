...
class DistributedSellbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def __talkAboutPromotion(self, speech):
        ...
        if self.mvpId == base.localAvatar.getDoId():
            speech += TTLocalizer.CagedToonMVP % (self.mvpScore * 2)
    ...
    def loadEnvironment(self):
        ...
        self.promotionMusic = loader.loadMusic('phase_9/audio/bgm/vp_intro.ogg')
