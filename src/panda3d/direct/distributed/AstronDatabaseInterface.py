    ...
    def handleQueryObjectResp(self, msgType, di):
        ...
        try:
            ...
            for x in xrange(fieldCount):
                ...
                field = dclass.getFieldByIndex(fieldId) # getFieldByIndex
    ...
    def handleUpdateObjectResp(self, di, multi):
        ...
        try:
            ...
            for x in xrange(fieldCount):
                ...
                if not config.GetBool('dc-multiple-inheritance', False):
                    print(self.air.getDcFile())
                    field = self.air.getDcFile().getField(fieldId)
                else:
