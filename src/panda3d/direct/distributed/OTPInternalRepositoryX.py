...
from direct.distributed.OTPDatabaseInterface import OTPDatabaseInterface
...
class OTPInternalRepositoryX(ConnectionRepository):
    notify = directNotify.newCategory('OTPInternalRepositoryX')
