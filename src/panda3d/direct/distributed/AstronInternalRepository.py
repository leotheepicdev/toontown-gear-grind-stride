...
class AstronInternalRepository(ConnectionRepository):
    ...
    def queryObjectAll(self, doId, context = 0):
        ...
        self.dbInterface.queryObject(4003, doId, self.__queryObjectCallback)

    def __queryObjectCallback(self, dclass, fields):
        messenger.send('doFieldResponse-{0}'.format(self.queryContext,), [self.queryContext, fields])
        self.queryContext = 0