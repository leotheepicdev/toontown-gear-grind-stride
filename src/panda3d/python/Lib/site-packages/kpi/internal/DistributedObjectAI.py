...
class DistributedObjectAI(UniqueObject, DirectObject):
    QuietZone = 1
    ...
    def requestDelete(self):
        if self.air is None:
            ...
            print('Tried to delete an already deleted do: %d' % doId)
            return
    ...
    def sendGenerateWithRequired(self, parentId, zoneId):
        ...
        for i in range(fieldCount):
            ...
            try:
                ...
                print('Failed to pack required field %s for %s' % (field, self.dclass))
                raise e
