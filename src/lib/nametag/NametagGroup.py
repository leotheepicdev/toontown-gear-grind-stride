...
class NametagGroup:
    ...
    def updateNametag(self, tag):
        ...
        if self.playerType == CCToon:
            # i dont think buildings have their own player type so just hack this in
            tag.wordWrap = 7.5
        else:
