...
from panda3d.core import ClockObject, GraphicsEngine, NodePath, Notify, PStatClient, PandaNode, RenderState, TransformState, TrueClock, VirtualFile, VirtualFileSystem, loadPrcFile, loadPrcFileData
import gc
import time
...
from toontown.base import BackupManagerAI
...
class AIBase:
    ...
    def __init__(self):
        ...
        self.backups = BackupManagerAI.BackupManagerAI(
