...
orange.setTextColor(0.85, 0.4, 0, 1)
TextPropertiesManager.getGlobalPtr().setProperties('orange', orange)
...
CRBootedReasons = {100: 'You have been disconnected because someone else just logged in using your account on another computer.',
 101: "Something has went wrong! Your connection has been lost, but you should be able to relogin and go right back into Toontown!",
 102: 'You are not authorized to use administrator privileges. You should be able to relogin and go right back into Toontown!',
 103: 'You were banned by a moderator.\n\nBehave next time!',
 105: 'Toontown: Gear Grind is now temporarily closed for maintenance. Everyone who was playing has been disconnected from the game.\n\nFor more information, please visit the Toontown: Gear Grind website.',
 106: 'An error has occurred while performing an action. Please contact a developer.',
 124: 'Your installed files are out of date!  Use the official launcher to download the newest version, or contact Toontown: Gear Grind support if the problem persists.',
...
CRMaintenanceCountdownMessage = 'Attention Toons! Toontown: Gear Grind will be going down for maintenance in %d minutes.'
CRMaintenanceMessage = 'Attention Toons! Toontown: Gear Grind is now going down for maintenance.'
CRCancelMaintenanceMessage = "Attention Toons! Toontown: Gear Grind's maintenance has been canceled."
...
SuitFaceoffTaunts = {'b': ['Do you have a donation for me?',
 ...
 'ttb': ['Gah! Seeing those Gags frustrate me.',
         "Uh oh! Looks like it's time to change your diaper."
         "Win is mine! Mine, mine, and mine!"],
 'lr': ['Ah! A new subject to experiment on.'],
 #'hs': [],
 'pg': ['You ready to grind? Grind your Laff Points out!',
        "You made a huge mistake. Encountering Toons is what grinds my gears.",
        'Defeating me will be a long grind.'],
 'wd': ["De Witch Doctor will not let Cogs be destroyed in Witch Doctor's presence."
        'Sacrificing your Laff Points grants protection from de Witch Doctor.',
        'Sacrifice is de only way outta here.',
        "Careful, Toon. Dis won't be a breeze for you.",
        "Did you hear that 'Spin Doctor' is jealous around de Witch Doctor?",
        'Hand your medicine over. Witch Doctor will take care of it.',
        "Dis won't hurt a little. Dis will hurt a lot.",
        'De Witch Doctor is in!'
        'Ready for a dose of de Witch Doctor?'],
...
SpeedChatStaticTextToontown = {100: 'Hi!',
 ...
 900: "I'm livestreaming!",
 901: 'Say hello to my livestream!',
 902: 'Press "F" to pay respects.',
 903: "I'm changing districts.",
 904: "Where we droppin' boys?",
 905: 'Follow me, everyone!',
 906: 'Send a bug report.',
 907: "My livestream is about to end!",
 1000: "Let's go!",
 ...
 5100: "Let's go to the Front Two.",
 5101: "Let's go to the Middle Four.",
 5102: "Let's go to the Back Six.",
 ...
 5200: "We're going to the Front Two.",
 5201: "We're going to the Middle Four.",
 5202: "We're going to the Back Six.",
...
AsciiNotSupported = 'Sorry, but non-ASCII characters are not supported.'
